...
namespace MinhaSaude.Controllers
{
    public class MedicamentosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Laboratorio,Tipo,PrincAtivo,Dosagem")] Medicamento medicamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Laboratorio,Tipo,PrincAtivo,Dosagem")] Medicamento medicamento)
        {
